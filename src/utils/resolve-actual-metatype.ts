/**
 * Resolves the actual class constructor from a wrapper, supporting both
 * regular class-based providers and factory-created instances.
 *
 * @param wrapper - InstanceWrapper from NestJS discovery
 *
 * @returns The actual class constructor if found, null otherwise
 */
export function resolveActualMetatype(wrapper: any): Function | null {
